...
func (r *jsiiProxy_Record) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (r *jsiiProxy_Record) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (r *jsiiProxy_Record) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func validateRecord_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func (j *jsiiProxy_Record) validateSetDomainParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_Record) validateSetFlagsParameters(val *float64) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_Record) validateSetPortParameters(val *float64) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_Record) validateSetTagParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_Record) validateSetWeightParameters(val *float64) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
