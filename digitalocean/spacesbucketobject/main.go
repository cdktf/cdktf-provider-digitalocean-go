...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SpacesBucketObject)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.spacesBucketObject.SpacesBucketObjectConfig",
		reflect.TypeOf((*SpacesBucketObjectConfig)(nil)).Elem(),
	)
}
