...
func (l *jsiiProxy_LoadbalancerStickySessionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LoadbalancerStickySessionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
