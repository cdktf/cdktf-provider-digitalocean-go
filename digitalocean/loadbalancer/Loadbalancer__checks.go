...
func (l *jsiiProxy_Loadbalancer) validatePutForwardingRuleParameters(value interface{}) error {
	...
	case *[]*LoadbalancerForwardingRule:
		value := value.(*[]*LoadbalancerForwardingRule)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*LoadbalancerForwardingRule:
		value_ := value.([]*LoadbalancerForwardingRule)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (j *jsiiProxy_Loadbalancer) validateSetNetworkParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_Loadbalancer) validateSetNetworkStackParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
