...
func (j *jsiiProxy_Project) validateSetEnvironmentParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_Project) validateSetIsDefaultParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_Project) validateSetPurposeParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Project) validateSetResourcesParameters(val *[]*string) error {
	return nil
}
