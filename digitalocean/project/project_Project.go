...
import (
	...
	"github.com/hashicorp/cdktf-provider-digitalocean-go/digitalocean/v3/project/internal"
...
func (j *jsiiProxy_Project) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_Project) Environment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"environment",
...
func (j *jsiiProxy_Project) EnvironmentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"environmentInput",
...
func (j *jsiiProxy_Project) OwnerId() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"ownerId",
...
func (j *jsiiProxy_Project) OwnerUuid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ownerUuid",
...
func (j *jsiiProxy_Project) Purpose() *string {
	var returns *string
	_jsii_.Get(
		j,
		"purpose",
...
func (j *jsiiProxy_Project) PurposeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"purposeInput",
...
func (j *jsiiProxy_Project) Resources() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resources",
...
func (j *jsiiProxy_Project) ResourcesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"resourcesInput",
...
func (j *jsiiProxy_Project) UpdatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updatedAt",
...
func NewProject(scope constructs.Construct, id *string, config *ProjectConfig) Project {
	...
	_jsii_.Create(
		"@cdktf/provider-digitalocean.project.Project",
...
func (j *jsiiProxy_Project)SetEnvironment(val *string) {
...
func (j *jsiiProxy_Project)SetPurpose(val *string) {
...
func (j *jsiiProxy_Project)SetResources(val *[]*string) {
...
func (p *jsiiProxy_Project) ResetEnvironment() {
	_jsii_.InvokeVoid(
		p,
		"resetEnvironment",
		nil, // no parameters
...
func (p *jsiiProxy_Project) ResetPurpose() {
	_jsii_.InvokeVoid(
		p,
		"resetPurpose",
		nil, // no parameters
...
func (p *jsiiProxy_Project) ResetResources() {
	_jsii_.InvokeVoid(
		p,
		"resetResources",
		nil, // no parameters
