...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.project.ProjectConfig",
		reflect.TypeOf((*ProjectConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.project.ProjectTimeouts",
		reflect.TypeOf((*ProjectTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-digitalocean.project.ProjectTimeoutsOutputReference",
