...
func (j *jsiiProxy_DataDigitaloceanGenaiAgentsAgentsTemplateKnowledgeBasesOutputReference) Uuid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uuid",
...
func (d *jsiiProxy_DataDigitaloceanGenaiAgentsAgentsTemplateKnowledgeBasesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDigitaloceanGenaiAgentsAgentsTemplateKnowledgeBasesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
