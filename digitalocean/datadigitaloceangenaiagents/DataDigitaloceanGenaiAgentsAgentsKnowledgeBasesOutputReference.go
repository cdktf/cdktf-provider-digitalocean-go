...
func (j *jsiiProxy_DataDigitaloceanGenaiAgentsAgentsKnowledgeBasesOutputReference) Uuid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uuid",
...
func (d *jsiiProxy_DataDigitaloceanGenaiAgentsAgentsKnowledgeBasesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDigitaloceanGenaiAgentsAgentsKnowledgeBasesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
