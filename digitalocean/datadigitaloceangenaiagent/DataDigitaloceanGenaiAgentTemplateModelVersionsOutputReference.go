...
func (d *jsiiProxy_DataDigitaloceanGenaiAgentTemplateModelVersionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDigitaloceanGenaiAgentTemplateModelVersionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
