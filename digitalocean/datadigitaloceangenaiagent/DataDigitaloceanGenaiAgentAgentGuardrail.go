...
type DataDigitaloceanGenaiAgentAgentGuardrail struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.62.0/docs/data-sources/genai_agent#agent_uuid DataDigitaloceanGenaiAgent#agent_uuid}
	AgentUuid *string `field:"optional" json:"agentUuid" yaml:"agentUuid"`
	// Default response for the Guardrail.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.62.0/docs/data-sources/genai_agent#default_response DataDigitaloceanGenaiAgent#default_response}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.62.0/docs/data-sources/genai_agent#is_default DataDigitaloceanGenaiAgent#is_default}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.62.0/docs/data-sources/genai_agent#priority DataDigitaloceanGenaiAgent#priority}
	Priority *float64 `field:"optional" json:"priority" yaml:"priority"`
	// Type of the Guardrail.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.62.0/docs/data-sources/genai_agent#type DataDigitaloceanGenaiAgent#type}
