...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDigitaloceanSpacesBucketObjects)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.dataDigitaloceanSpacesBucketObjects.DataDigitaloceanSpacesBucketObjectsConfig",
		reflect.TypeOf((*DataDigitaloceanSpacesBucketObjectsConfig)(nil)).Elem(),
	)
}
