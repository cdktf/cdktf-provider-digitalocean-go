...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SpacesBucketCorsConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.spacesBucketCorsConfiguration.SpacesBucketCorsConfigurationConfig",
		reflect.TypeOf((*SpacesBucketCorsConfigurationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.spacesBucketCorsConfiguration.SpacesBucketCorsConfigurationCorsRule",
		reflect.TypeOf((*SpacesBucketCorsConfigurationCorsRule)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-digitalocean.spacesBucketCorsConfiguration.SpacesBucketCorsConfigurationCorsRuleList",
		reflect.TypeOf((*SpacesBucketCorsConfigurationCorsRuleList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SpacesBucketCorsConfigurationCorsRuleOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
