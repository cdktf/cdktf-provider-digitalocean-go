...
func (p *jsiiProxy_PartnerAttachmentBgpOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PartnerAttachmentBgpOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
