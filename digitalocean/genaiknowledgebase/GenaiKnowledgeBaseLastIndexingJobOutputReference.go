...
func (g *jsiiProxy_GenaiKnowledgeBaseLastIndexingJobOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GenaiKnowledgeBaseLastIndexingJobOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
