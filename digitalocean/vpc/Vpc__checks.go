...
func (v *jsiiProxy_Vpc) validatePutTimeoutsParameters(value *VpcTimeouts) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (j *jsiiProxy_Vpc) validateSetDescriptionParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_Vpc) validateSetIpRangeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_Vpc) validateSetNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
