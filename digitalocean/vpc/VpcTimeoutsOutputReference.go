...
import (
	...
	"github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v13/vpc/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

type VpcTimeoutsOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for VpcTimeoutsOutputReference
type jsiiProxy_VpcTimeoutsOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_VpcTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_VpcTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VpcTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_VpcTimeoutsOutputReference) Delete() *string {
	var returns *string
	_jsii_.Get(
		j,
		"delete",
...
func (j *jsiiProxy_VpcTimeoutsOutputReference) DeleteInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deleteInput",
...
func (j *jsiiProxy_VpcTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_VpcTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_VpcTimeoutsOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_VpcTimeoutsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewVpcTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) VpcTimeoutsOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-digitalocean.vpc.VpcTimeoutsOutputReference",
...
func NewVpcTimeoutsOutputReference_Override(v VpcTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (v *jsiiProxy_VpcTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (v *jsiiProxy_VpcTimeoutsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (v *jsiiProxy_VpcTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpcTimeoutsOutputReference) ResetDelete() {
	_jsii_.InvokeVoid(
		v,
		"resetDelete",
		nil, // no parameters
...
func (v *jsiiProxy_VpcTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (v *jsiiProxy_VpcTimeoutsOutputReference) ToString() *string {
	var returns *string
