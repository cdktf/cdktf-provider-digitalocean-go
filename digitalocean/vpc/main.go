...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.vpc.VpcConfig",
		reflect.TypeOf((*VpcConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.vpc.VpcTimeouts",
		reflect.TypeOf((*VpcTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-digitalocean.vpc.VpcTimeoutsOutputReference",
		reflect.TypeOf((*VpcTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
