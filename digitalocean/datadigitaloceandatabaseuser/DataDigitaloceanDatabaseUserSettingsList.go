...
func (d *jsiiProxy_DataDigitaloceanDatabaseUserSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDigitaloceanDatabaseUserSettingsList) Resolve(context cdktf.IResolveContext) interface{} {
