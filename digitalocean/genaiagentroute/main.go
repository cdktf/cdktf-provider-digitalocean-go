...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GenaiAgentRoute)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "childAgentUuid", GoGetter: "ChildAgentUuid"},
			_jsii_.MemberProperty{JsiiProperty: "childAgentUuidInput", GoGetter: "ChildAgentUuidInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "parentAgentUuid", GoGetter: "ParentAgentUuid"},
			_jsii_.MemberProperty{JsiiProperty: "parentAgentUuidInput", GoGetter: "ParentAgentUuidInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.genaiAgentRoute.GenaiAgentRouteConfig",
		reflect.TypeOf((*GenaiAgentRouteConfig)(nil)).Elem(),
	)
}
