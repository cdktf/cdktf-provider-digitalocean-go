...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDigitaloceanSpacesBucketObject)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.dataDigitaloceanSpacesBucketObject.DataDigitaloceanSpacesBucketObjectConfig",
		reflect.TypeOf((*DataDigitaloceanSpacesBucketObjectConfig)(nil)).Elem(),
	)
}
