...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDigitaloceanDroplet)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.dataDigitaloceanDroplet.DataDigitaloceanDropletConfig",
		reflect.TypeOf((*DataDigitaloceanDropletConfig)(nil)).Elem(),
	)
}
