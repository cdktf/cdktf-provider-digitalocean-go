...
import (
	...
	"github.com/hashicorp/cdktf-provider-digitalocean-go/digitalocean/v3/datadigitaloceandroplet/internal"
...
func (j *jsiiProxy_DataDigitaloceanDroplet) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataDigitaloceanDroplet)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
