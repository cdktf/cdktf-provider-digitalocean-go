...
import (
	...
	"github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v13/datadigitaloceandroplet/internal"
...
func DataDigitaloceanDroplet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataDigitaloceanDroplet_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataDigitaloceanDroplet) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataDigitaloceanDroplet) ToHclTerraform() interface{} {
	var returns interface{}
