...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*UptimeAlert)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.uptimeAlert.UptimeAlertConfig",
		reflect.TypeOf((*UptimeAlertConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.uptimeAlert.UptimeAlertNotifications",
		reflect.TypeOf((*UptimeAlertNotifications)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-digitalocean.uptimeAlert.UptimeAlertNotificationsList",
		reflect.TypeOf((*UptimeAlertNotificationsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*UptimeAlertNotificationsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.uptimeAlert.UptimeAlertNotificationsSlack",
		reflect.TypeOf((*UptimeAlertNotificationsSlack)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-digitalocean.uptimeAlert.UptimeAlertNotificationsSlackList",
		reflect.TypeOf((*UptimeAlertNotificationsSlackList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*UptimeAlertNotificationsSlackOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
