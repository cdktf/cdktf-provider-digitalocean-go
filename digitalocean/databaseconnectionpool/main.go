...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatabaseConnectionPool)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.databaseConnectionPool.DatabaseConnectionPoolConfig",
		reflect.TypeOf((*DatabaseConnectionPoolConfig)(nil)).Elem(),
	)
}
