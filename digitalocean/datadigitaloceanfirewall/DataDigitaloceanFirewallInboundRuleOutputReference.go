...
func (d *jsiiProxy_DataDigitaloceanFirewallInboundRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDigitaloceanFirewallInboundRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
