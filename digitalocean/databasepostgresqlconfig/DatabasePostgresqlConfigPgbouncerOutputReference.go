...
func (d *jsiiProxy_DatabasePostgresqlConfigPgbouncerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DatabasePostgresqlConfigPgbouncerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
