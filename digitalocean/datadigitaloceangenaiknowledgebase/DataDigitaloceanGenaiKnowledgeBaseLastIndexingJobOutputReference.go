...
func (d *jsiiProxy_DataDigitaloceanGenaiKnowledgeBaseLastIndexingJobOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDigitaloceanGenaiKnowledgeBaseLastIndexingJobOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
