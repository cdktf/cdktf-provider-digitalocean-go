...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GenaiKnowledgeBaseDataSource)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.genaiKnowledgeBaseDataSource.GenaiKnowledgeBaseDataSourceConfig",
		reflect.TypeOf((*GenaiKnowledgeBaseDataSourceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.genaiKnowledgeBaseDataSource.GenaiKnowledgeBaseDataSourceSpacesDataSource",
		reflect.TypeOf((*GenaiKnowledgeBaseDataSourceSpacesDataSource)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-digitalocean.genaiKnowledgeBaseDataSource.GenaiKnowledgeBaseDataSourceSpacesDataSourceOutputReference",
		reflect.TypeOf((*GenaiKnowledgeBaseDataSourceSpacesDataSourceOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.genaiKnowledgeBaseDataSource.GenaiKnowledgeBaseDataSourceWebCrawlerDataSource",
		reflect.TypeOf((*GenaiKnowledgeBaseDataSourceWebCrawlerDataSource)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-digitalocean.genaiKnowledgeBaseDataSource.GenaiKnowledgeBaseDataSourceWebCrawlerDataSourceOutputReference",
		reflect.TypeOf((*GenaiKnowledgeBaseDataSourceWebCrawlerDataSourceOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
