...
func (g *jsiiProxy_GenaiKnowledgeBaseDataSourceSpacesDataSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GenaiKnowledgeBaseDataSourceSpacesDataSourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
