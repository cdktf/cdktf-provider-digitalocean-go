...
func (d *jsiiProxy_DropletBackupPolicyOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DropletBackupPolicyOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
