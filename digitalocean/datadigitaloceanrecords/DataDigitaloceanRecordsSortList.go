...
func (d *jsiiProxy_DataDigitaloceanRecordsSortList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDigitaloceanRecordsSortList) Resolve(context cdktf.IResolveContext) interface{} {
