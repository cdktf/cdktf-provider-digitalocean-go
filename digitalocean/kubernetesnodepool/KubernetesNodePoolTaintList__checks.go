...
func (k *jsiiProxy_KubernetesNodePoolTaintList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (k *jsiiProxy_KubernetesNodePoolTaintList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
