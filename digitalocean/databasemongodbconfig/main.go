...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatabaseMongodbConfig)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSlowOpThresholdMs", GoMethod: "ResetSlowOpThresholdMs"},
			...
			_jsii_.MemberProperty{JsiiProperty: "slowOpThresholdMs", GoGetter: "SlowOpThresholdMs"},
			_jsii_.MemberProperty{JsiiProperty: "slowOpThresholdMsInput", GoGetter: "SlowOpThresholdMsInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.databaseMongodbConfig.DatabaseMongodbConfigConfig",
		reflect.TypeOf((*DatabaseMongodbConfigConfig)(nil)).Elem(),
	)
}
