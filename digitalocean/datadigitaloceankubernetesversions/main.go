...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDigitaloceanKubernetesVersions)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.dataDigitaloceanKubernetesVersions.DataDigitaloceanKubernetesVersionsConfig",
		reflect.TypeOf((*DataDigitaloceanKubernetesVersionsConfig)(nil)).Elem(),
	)
}
