...
import (
	...
	"github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v13/datadigitaloceankubernetesversions/internal"
...
func (j *jsiiProxy_DataDigitaloceanKubernetesVersions) Count() interface{} {
...
func (j *jsiiProxy_DataDigitaloceanKubernetesVersions)SetCount(val interface{}) {
...
func DataDigitaloceanKubernetesVersions_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataDigitaloceanKubernetesVersions_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataDigitaloceanKubernetesVersions) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataDigitaloceanKubernetesVersions) ToHclTerraform() interface{} {
	var returns interface{}
