...
func (a *jsiiProxy_AppSpecFunctionAlertOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppSpecFunctionAlertOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
