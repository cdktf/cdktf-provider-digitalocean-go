...
func (a *jsiiProxy_AppSpecFunctionCorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppSpecFunctionCorsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
