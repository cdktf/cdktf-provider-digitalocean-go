...
func (a *jsiiProxy_AppSpecServiceGithubOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppSpecServiceGithubOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
