...
func (a *jsiiProxy_AppSpecServiceLogDestinationList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (a *jsiiProxy_AppSpecServiceLogDestinationList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
