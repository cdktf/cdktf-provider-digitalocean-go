...
func (a *jsiiProxy_AppSpecAlertOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppSpecAlertOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
