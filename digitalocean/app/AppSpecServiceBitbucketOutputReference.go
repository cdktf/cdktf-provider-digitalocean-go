...
func (a *jsiiProxy_AppSpecServiceBitbucketOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppSpecServiceBitbucketOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
