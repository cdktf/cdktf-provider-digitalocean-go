...
func (a *jsiiProxy_App) validatePutDedicatedIpsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*AppDedicatedIps; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_App) validateSetProjectIdParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
