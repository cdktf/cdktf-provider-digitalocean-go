...
func (a *jsiiProxy_AppSpecJobImageDeployOnPushOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppSpecJobImageDeployOnPushOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
