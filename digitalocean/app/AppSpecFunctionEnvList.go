...
type AppSpecFunctionEnvList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) AppSpecFunctionEnvOutputReference
...
// The jsii proxy struct for AppSpecFunctionEnvList
type jsiiProxy_AppSpecFunctionEnvList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_AppSpecFunctionEnvList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AppSpecFunctionEnvList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AppSpecFunctionEnvList) InternalValue() interface{} {
...
func (j *jsiiProxy_AppSpecFunctionEnvList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AppSpecFunctionEnvList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_AppSpecFunctionEnvList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (a *jsiiProxy_AppSpecFunctionEnvList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppSpecFunctionEnvList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AppSpecFunctionEnvList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (a *jsiiProxy_AppSpecFunctionEnvList) ToString() *string {
	var returns *string
