...
func (a *jsiiProxy_AppSpecWorkerGithubOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppSpecWorkerGithubOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
