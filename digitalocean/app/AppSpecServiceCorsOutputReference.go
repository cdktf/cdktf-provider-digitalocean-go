...
func (a *jsiiProxy_AppSpecServiceCorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppSpecServiceCorsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
