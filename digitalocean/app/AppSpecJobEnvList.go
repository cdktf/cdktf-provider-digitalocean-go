...
type AppSpecJobEnvList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) AppSpecJobEnvOutputReference
...
// The jsii proxy struct for AppSpecJobEnvList
type jsiiProxy_AppSpecJobEnvList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_AppSpecJobEnvList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AppSpecJobEnvList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AppSpecJobEnvList) InternalValue() interface{} {
...
func (j *jsiiProxy_AppSpecJobEnvList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AppSpecJobEnvList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_AppSpecJobEnvList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (a *jsiiProxy_AppSpecJobEnvList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppSpecJobEnvList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AppSpecJobEnvList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (a *jsiiProxy_AppSpecJobEnvList) ToString() *string {
	var returns *string
