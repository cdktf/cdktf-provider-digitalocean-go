...
func (a *jsiiProxy_AppSpecStaticSiteGithubOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppSpecStaticSiteGithubOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
