...
func (a *jsiiProxy_AppSpecFunctionLogDestinationList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (a *jsiiProxy_AppSpecFunctionLogDestinationList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
