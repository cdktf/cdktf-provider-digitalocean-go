...
type AppSpecJobList interface {
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) AppSpecJobOutputReference
...
// The jsii proxy struct for AppSpecJobList
type jsiiProxy_AppSpecJobList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_AppSpecJobList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AppSpecJobList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AppSpecJobList) InternalValue() interface{} {
...
func (j *jsiiProxy_AppSpecJobList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AppSpecJobList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_AppSpecJobList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (a *jsiiProxy_AppSpecJobList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppSpecJobList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AppSpecJobList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (a *jsiiProxy_AppSpecJobList) ToString() *string {
	var returns *string
