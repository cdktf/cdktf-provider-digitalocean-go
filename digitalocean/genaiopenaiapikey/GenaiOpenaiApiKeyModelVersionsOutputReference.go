...
func (g *jsiiProxy_GenaiOpenaiApiKeyModelVersionsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GenaiOpenaiApiKeyModelVersionsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
