...
func (p *jsiiProxy_ProjectResources) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (p *jsiiProxy_ProjectResources) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (p *jsiiProxy_ProjectResources) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (p *jsiiProxy_ProjectResources) validateMoveToParameters(moveTarget *string, index interface{}) error {
	if moveTarget == nil {
		return fmt.Errorf("parameter moveTarget is required, but nil was provided")
	}
...
func (p *jsiiProxy_ProjectResources) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func validateProjectResources_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func (j *jsiiProxy_ProjectResources) validateSetCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
