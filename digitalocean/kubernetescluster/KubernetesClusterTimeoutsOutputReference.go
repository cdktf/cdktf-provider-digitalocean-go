...
func NewKubernetesClusterTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) KubernetesClusterTimeoutsOutputReference {
	...
	if err := validateNewKubernetesClusterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KubernetesClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
