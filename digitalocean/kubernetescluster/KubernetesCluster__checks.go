...
func (k *jsiiProxy_KubernetesCluster) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (k *jsiiProxy_KubernetesCluster) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (k *jsiiProxy_KubernetesCluster) validatePutClusterAutoscalerConfigurationParameters(value interface{}) error {
	...
	case *[]*KubernetesClusterClusterAutoscalerConfiguration:
		value := value.(*[]*KubernetesClusterClusterAutoscalerConfiguration)
	...
	case []*KubernetesClusterClusterAutoscalerConfiguration:
		value_ := value.([]*KubernetesClusterClusterAutoscalerConfiguration)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*KubernetesClusterClusterAutoscalerConfiguration; received %#v (a %T)", value, value)
		}
	}
...
func (k *jsiiProxy_KubernetesCluster) validatePutNodePoolParameters(value *KubernetesClusterNodePool) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func validateKubernetesCluster_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func (j *jsiiProxy_KubernetesCluster) validateSetAutoUpgradeParameters(val interface{}) error {
	if val == nil {
...
func (j *jsiiProxy_KubernetesCluster) validateSetClusterSubnetParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_KubernetesCluster) validateSetRegionParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_KubernetesCluster) validateSetServiceSubnetParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_KubernetesCluster) validateSetTagsParameters(val *[]*string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_KubernetesCluster) validateSetVpcUuidParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
