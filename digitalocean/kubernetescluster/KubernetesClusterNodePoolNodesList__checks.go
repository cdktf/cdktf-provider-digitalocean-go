...
func (k *jsiiProxy_KubernetesClusterNodePoolNodesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (k *jsiiProxy_KubernetesClusterNodePoolNodesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
