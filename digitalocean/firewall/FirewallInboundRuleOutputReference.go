...
func (f *jsiiProxy_FirewallInboundRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FirewallInboundRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
