...
type FirewallPendingChangesList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) FirewallPendingChangesOutputReference
...
// The jsii proxy struct for FirewallPendingChangesList
type jsiiProxy_FirewallPendingChangesList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_FirewallPendingChangesList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_FirewallPendingChangesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_FirewallPendingChangesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_FirewallPendingChangesList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_FirewallPendingChangesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (f *jsiiProxy_FirewallPendingChangesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPendingChangesList) ComputeFqn() *string {
	var returns *string
...
func (f *jsiiProxy_FirewallPendingChangesList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (f *jsiiProxy_FirewallPendingChangesList) ToString() *string {
	var returns *string
