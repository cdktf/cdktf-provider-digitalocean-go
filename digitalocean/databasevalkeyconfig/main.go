...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatabaseValkeyConfig)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "frequentSnapshots", GoGetter: "FrequentSnapshots"},
			_jsii_.MemberProperty{JsiiProperty: "frequentSnapshotsInput", GoGetter: "FrequentSnapshotsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFrequentSnapshots", GoMethod: "ResetFrequentSnapshots"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetValkeyActiveExpireEffort", GoMethod: "ResetValkeyActiveExpireEffort"},
			...
			_jsii_.MemberProperty{JsiiProperty: "valkeyActiveExpireEffort", GoGetter: "ValkeyActiveExpireEffort"},
			_jsii_.MemberProperty{JsiiProperty: "valkeyActiveExpireEffortInput", GoGetter: "ValkeyActiveExpireEffortInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.databaseValkeyConfig.DatabaseValkeyConfigConfig",
		reflect.TypeOf((*DatabaseValkeyConfigConfig)(nil)).Elem(),
	)
}
