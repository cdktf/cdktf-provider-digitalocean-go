...
func (d *jsiiProxy_DataDigitaloceanKubernetesClusterKubeConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDigitaloceanKubernetesClusterKubeConfigList) Resolve(context cdktf.IResolveContext) interface{} {
