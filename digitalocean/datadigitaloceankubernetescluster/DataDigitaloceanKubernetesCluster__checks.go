...
func (d *jsiiProxy_DataDigitaloceanKubernetesCluster) validatePutClusterAutoscalerConfigurationParameters(value interface{}) error {
	...
	case *[]*DataDigitaloceanKubernetesClusterClusterAutoscalerConfiguration:
		value := value.(*[]*DataDigitaloceanKubernetesClusterClusterAutoscalerConfiguration)
	...
	case []*DataDigitaloceanKubernetesClusterClusterAutoscalerConfiguration:
		value_ := value.([]*DataDigitaloceanKubernetesClusterClusterAutoscalerConfiguration)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*DataDigitaloceanKubernetesClusterClusterAutoscalerConfiguration; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DataDigitaloceanKubernetesCluster) validatePutRoutingAgentParameters(value *DataDigitaloceanKubernetesClusterRoutingAgent) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func validateDataDigitaloceanKubernetesCluster_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func validateDataDigitaloceanKubernetesCluster_IsTerraformDataSourceParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func validateDataDigitaloceanKubernetesCluster_IsTerraformElementParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func (j *jsiiProxy_DataDigitaloceanKubernetesCluster) validateSetKubeconfigExpireSecondsParameters(val *float64) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
