...
func (d *jsiiProxy_DataDigitaloceanKubernetesClusterNodePoolNodesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDigitaloceanKubernetesClusterNodePoolNodesList) Resolve(context cdktf.IResolveContext) interface{} {
