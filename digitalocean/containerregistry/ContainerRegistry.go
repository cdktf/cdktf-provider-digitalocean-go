...
import (
	...
	"github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v13/containerregistry/internal"
...
type ContainerRegistry interface {
	...
	SetSubscriptionTierSlug(val *string)
	SubscriptionTierSlugInput() *string
	// Experimental.
...
func (j *jsiiProxy_ContainerRegistry) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_ContainerRegistry) Endpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"endpoint",
...
func (j *jsiiProxy_ContainerRegistry) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ContainerRegistry) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ContainerRegistry) ServerUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serverUrl",
...
func (j *jsiiProxy_ContainerRegistry) StorageUsageBytes() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"storageUsageBytes",
...
func (j *jsiiProxy_ContainerRegistry) SubscriptionTierSlug() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerRegistry) SubscriptionTierSlugInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subscriptionTierSlugInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.55.0/docs/resources/container_registry digitalocean_container_registry} Resource.
func NewContainerRegistry(scope constructs.Construct, id *string, config *ContainerRegistryConfig) ContainerRegistry {
	...
	_jsii_.Create(
		"@cdktf/provider-digitalocean.containerRegistry.ContainerRegistry",
...
func (j *jsiiProxy_ContainerRegistry)SetRegion(val *string) {
...
func (j *jsiiProxy_ContainerRegistry)SetSubscriptionTierSlug(val *string) {
	if err := j.validateSetSubscriptionTierSlugParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (c *jsiiProxy_ContainerRegistry) ResetRegion() {
	_jsii_.InvokeVoid(
		c,
		"resetRegion",
		nil, // no parameters
