...
import (
	...
	"github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v11/containerregistrydockercredentials/internal"
...
func (j *jsiiProxy_ContainerRegistryDockerCredentials) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.44.1/docs/resources/container_registry_docker_credentials digitalocean_container_registry_docker_credentials} Resource.
func NewContainerRegistryDockerCredentials(scope constructs.Construct, id *string, config *ContainerRegistryDockerCredentialsConfig) ContainerRegistryDockerCredentials {
	...
	_jsii_.Create(
		"@cdktf/provider-digitalocean.containerRegistryDockerCredentials.ContainerRegistryDockerCredentials",
...
func (j *jsiiProxy_ContainerRegistryDockerCredentials)SetCount(val interface{}) {
...
func ContainerRegistryDockerCredentials_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateContainerRegistryDockerCredentials_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func ContainerRegistryDockerCredentials_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateContainerRegistryDockerCredentials_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ContainerRegistryDockerCredentials_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateContainerRegistryDockerCredentials_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_ContainerRegistryDockerCredentials) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ContainerRegistryDockerCredentials) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ContainerRegistryDockerCredentials) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ContainerRegistryDockerCredentials) MoveFromId(id *string) {
...
func (c *jsiiProxy_ContainerRegistryDockerCredentials) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_ContainerRegistryDockerCredentials) MoveToId(id *string) {
...
func (c *jsiiProxy_ContainerRegistryDockerCredentials) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ContainerRegistryDockerCredentials) ToHclTerraform() interface{} {
	var returns interface{}
