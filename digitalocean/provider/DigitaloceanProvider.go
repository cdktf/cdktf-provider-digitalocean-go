...
import (
	...
	"github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v11/provider/internal"
...
// Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.37.1/docs digitalocean} Resource.
...
func (d *jsiiProxy_DigitaloceanProvider) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DigitaloceanProvider) ToHclTerraform() interface{} {
	var returns interface{}
