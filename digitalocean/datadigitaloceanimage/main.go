...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDigitaloceanImage)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.dataDigitaloceanImage.DataDigitaloceanImageConfig",
		reflect.TypeOf((*DataDigitaloceanImageConfig)(nil)).Elem(),
	)
}
