...
func (g *jsiiProxy_GenaiAgentParentAgentsChatbotOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GenaiAgentParentAgentsChatbotOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
