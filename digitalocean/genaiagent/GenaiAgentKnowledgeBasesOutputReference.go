...
func (g *jsiiProxy_GenaiAgentKnowledgeBasesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GenaiAgentKnowledgeBasesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
