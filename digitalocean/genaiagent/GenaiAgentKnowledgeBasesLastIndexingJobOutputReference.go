...
func (g *jsiiProxy_GenaiAgentKnowledgeBasesLastIndexingJobOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GenaiAgentKnowledgeBasesLastIndexingJobOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
