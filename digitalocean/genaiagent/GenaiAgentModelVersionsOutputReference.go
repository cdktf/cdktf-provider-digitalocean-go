...
func (g *jsiiProxy_GenaiAgentModelVersionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GenaiAgentModelVersionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
