...
func (g *jsiiProxy_GenaiAgentChildAgentsChatbotOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GenaiAgentChildAgentsChatbotOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
