...
func (g *jsiiProxy_GenaiAgentParentAgentsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GenaiAgentParentAgentsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
