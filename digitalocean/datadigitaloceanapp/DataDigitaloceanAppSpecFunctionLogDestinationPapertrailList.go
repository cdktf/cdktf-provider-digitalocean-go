...
func (d *jsiiProxy_DataDigitaloceanAppSpecFunctionLogDestinationPapertrailList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecFunctionLogDestinationPapertrailList) Resolve(context cdktf.IResolveContext) interface{} {
