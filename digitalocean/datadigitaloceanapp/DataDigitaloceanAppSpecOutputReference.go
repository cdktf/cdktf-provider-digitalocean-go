...
func (d *jsiiProxy_DataDigitaloceanAppSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
