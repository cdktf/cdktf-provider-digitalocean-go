...
func (d *jsiiProxy_DataDigitaloceanAppSpecWorkerAlertList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecWorkerAlertList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
