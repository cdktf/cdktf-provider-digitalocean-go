...
func (d *jsiiProxy_DataDigitaloceanAppSpecFunctionEnvList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataDigitaloceanAppSpecFunctionEnvList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
