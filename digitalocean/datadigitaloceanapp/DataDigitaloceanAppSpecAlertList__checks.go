...
func (d *jsiiProxy_DataDigitaloceanAppSpecAlertList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecAlertList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
