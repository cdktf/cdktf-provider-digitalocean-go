...
func (d *jsiiProxy_DataDigitaloceanAppSpecWorkerImageDeployOnPushList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecWorkerImageDeployOnPushList) Resolve(context cdktf.IResolveContext) interface{} {
