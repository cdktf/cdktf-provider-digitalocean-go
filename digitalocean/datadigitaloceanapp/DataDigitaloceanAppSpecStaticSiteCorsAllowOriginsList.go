...
func (d *jsiiProxy_DataDigitaloceanAppSpecStaticSiteCorsAllowOriginsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecStaticSiteCorsAllowOriginsList) Resolve(context cdktf.IResolveContext) interface{} {
