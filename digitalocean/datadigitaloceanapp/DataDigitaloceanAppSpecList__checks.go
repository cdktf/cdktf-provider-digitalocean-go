...
func (d *jsiiProxy_DataDigitaloceanAppSpecList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
