...
func (d *jsiiProxy_DataDigitaloceanAppSpecServiceLogDestinationDatadogList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecServiceLogDestinationDatadogList) Resolve(context cdktf.IResolveContext) interface{} {
