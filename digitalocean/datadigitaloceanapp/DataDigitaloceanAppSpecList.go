...
func NewDataDigitaloceanAppSpecList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataDigitaloceanAppSpecList {
	...
	if err := validateNewDataDigitaloceanAppSpecListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataDigitaloceanAppSpecList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
