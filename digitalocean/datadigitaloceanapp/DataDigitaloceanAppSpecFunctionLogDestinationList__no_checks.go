...
func (d *jsiiProxy_DataDigitaloceanAppSpecFunctionLogDestinationList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataDigitaloceanAppSpecFunctionLogDestinationList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
