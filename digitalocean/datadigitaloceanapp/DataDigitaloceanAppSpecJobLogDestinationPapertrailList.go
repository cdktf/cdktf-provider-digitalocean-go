...
func (d *jsiiProxy_DataDigitaloceanAppSpecJobLogDestinationPapertrailList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecJobLogDestinationPapertrailList) Resolve(context cdktf.IResolveContext) interface{} {
