...
func (d *jsiiProxy_DataDigitaloceanAppSpecFunctionLogDestinationDatadogList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecFunctionLogDestinationDatadogList) Resolve(context cdktf.IResolveContext) interface{} {
