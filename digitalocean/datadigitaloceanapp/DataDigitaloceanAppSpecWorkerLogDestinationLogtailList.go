...
func (d *jsiiProxy_DataDigitaloceanAppSpecWorkerLogDestinationLogtailList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecWorkerLogDestinationLogtailList) Resolve(context cdktf.IResolveContext) interface{} {
