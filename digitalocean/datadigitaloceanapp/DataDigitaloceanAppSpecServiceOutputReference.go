...
func (j *jsiiProxy_DataDigitaloceanAppSpecServiceOutputReference) Bitbucket() DataDigitaloceanAppSpecServiceBitbucketList {
	var returns DataDigitaloceanAppSpecServiceBitbucketList
	_jsii_.Get(
		j,
		"bitbucket",
		&returns,
...
func (d *jsiiProxy_DataDigitaloceanAppSpecServiceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecServiceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
