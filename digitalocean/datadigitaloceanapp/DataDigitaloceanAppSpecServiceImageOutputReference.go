...
func (j *jsiiProxy_DataDigitaloceanAppSpecServiceImageOutputReference) Digest() *string {
	var returns *string
	_jsii_.Get(
		j,
		"digest",
...
func (d *jsiiProxy_DataDigitaloceanAppSpecServiceImageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecServiceImageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
