...
func (d *jsiiProxy_DataDigitaloceanAppSpecServiceRoutesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecServiceRoutesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
