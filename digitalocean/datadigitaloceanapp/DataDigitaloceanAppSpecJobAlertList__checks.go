...
func (d *jsiiProxy_DataDigitaloceanAppSpecJobAlertList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecJobAlertList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
