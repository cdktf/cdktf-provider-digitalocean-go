...
func (d *jsiiProxy_DataDigitaloceanAppSpecJobLogDestinationLogtailList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDigitaloceanAppSpecJobLogDestinationLogtailList) Resolve(context cdktf.IResolveContext) interface{} {
