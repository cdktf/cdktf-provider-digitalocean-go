...
func (d *jsiiProxy_DataDigitaloceanLoadbalancerStickySessionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataDigitaloceanLoadbalancerStickySessionsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
