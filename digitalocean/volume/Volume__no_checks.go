...
func (j *jsiiProxy_Volume) validateSetDescriptionParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Volume) validateSetFilesystemTypeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_Volume) validateSetInitialFilesystemLabelParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Volume) validateSetInitialFilesystemTypeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_Volume) validateSetSnapshotIdParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Volume) validateSetTagsParameters(val *[]*string) error {
	return nil
}
