...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDigitaloceanDatabaseReplica)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.dataDigitaloceanDatabaseReplica.DataDigitaloceanDatabaseReplicaConfig",
		reflect.TypeOf((*DataDigitaloceanDatabaseReplicaConfig)(nil)).Elem(),
	)
}
