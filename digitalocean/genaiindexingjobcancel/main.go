...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GenaiIndexingJobCancel)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.genaiIndexingJobCancel.GenaiIndexingJobCancelConfig",
		reflect.TypeOf((*GenaiIndexingJobCancelConfig)(nil)).Elem(),
	)
}
