...
import (
	...
	"github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v11/floatingip/internal"
...
// Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.40.0/docs/resources/floating_ip digitalocean_floating_ip} Resource.
func NewFloatingIp(scope constructs.Construct, id *string, config *FloatingIpConfig) FloatingIp {
	_init_.Initialize()

	if err := validateNewFloatingIpParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_FloatingIp{}

	_jsii_.Create(
		"@cdktf/provider-digitalocean.floatingIp.FloatingIp",
...
func FloatingIp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateFloatingIp_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func FloatingIp_IsConstruct(x interface{}) *bool {
	...
	if err := validateFloatingIp_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func FloatingIp_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateFloatingIp_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func FloatingIp_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateFloatingIp_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (f *jsiiProxy_FloatingIp) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FloatingIp) HasResourceMove() interface{} {
	var returns interface{}
...
func (f *jsiiProxy_FloatingIp) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (f *jsiiProxy_FloatingIp) MoveFromId(id *string) {
...
func (f *jsiiProxy_FloatingIp) MoveTo(moveTarget *string, index interface{}) {
...
func (f *jsiiProxy_FloatingIp) MoveToId(id *string) {
...
func (f *jsiiProxy_FloatingIp) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (f *jsiiProxy_FloatingIp) ToHclTerraform() interface{} {
	var returns interface{}
