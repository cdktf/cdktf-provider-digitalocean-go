...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatabaseOnlineMigration)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDisableSsl", GoMethod: "ResetDisableSsl"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.databaseOnlineMigration.DatabaseOnlineMigrationConfig",
		reflect.TypeOf((*DatabaseOnlineMigrationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.databaseOnlineMigration.DatabaseOnlineMigrationSource",
		reflect.TypeOf((*DatabaseOnlineMigrationSource)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-digitalocean.databaseOnlineMigration.DatabaseOnlineMigrationSourceOutputReference",
		reflect.TypeOf((*DatabaseOnlineMigrationSourceOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
