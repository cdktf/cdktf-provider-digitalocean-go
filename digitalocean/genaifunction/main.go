...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GenaiFunction)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "functionUuid", GoGetter: "FunctionUuid"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.genaiFunction.GenaiFunctionConfig",
		reflect.TypeOf((*GenaiFunctionConfig)(nil)).Elem(),
	)
}
