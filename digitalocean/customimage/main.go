...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.customImage.CustomImageConfig",
		reflect.TypeOf((*CustomImageConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.customImage.CustomImageTimeouts",
		reflect.TypeOf((*CustomImageTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-digitalocean.customImage.CustomImageTimeoutsOutputReference",
		reflect.TypeOf((*CustomImageTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
