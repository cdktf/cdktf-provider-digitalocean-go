...
type DatabaseUser interface {
	...
	SetMysqlAuthPlugin(val *string)
	MysqlAuthPluginInput() *string
	Name() *string
	SetName(val *string)
	NameInput() *string
	// The tree node.
...
func (j *jsiiProxy_DatabaseUser) ClusterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterId",
...
func (j *jsiiProxy_DatabaseUser) ClusterIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterIdInput",
...
func (j *jsiiProxy_DatabaseUser) MysqlAuthPlugin() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mysqlAuthPlugin",
...
func (j *jsiiProxy_DatabaseUser) MysqlAuthPluginInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mysqlAuthPluginInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_DatabaseUser) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DatabaseUser) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DatabaseUser) Role() *string {
	var returns *string
	_jsii_.Get(
		j,
		"role",
...
// Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.40.0/docs/resources/database_user digitalocean_database_user} Resource.
...
func (j *jsiiProxy_DatabaseUser)SetClusterId(val *string) {
...
func (j *jsiiProxy_DatabaseUser)SetMysqlAuthPlugin(val *string) {
	if err := j.validateSetMysqlAuthPluginParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_DatabaseUser)SetName(val *string) {
...
func (d *jsiiProxy_DatabaseUser) ResetMysqlAuthPlugin() {
	_jsii_.InvokeVoid(
		d,
		"resetMysqlAuthPlugin",
		nil, // no parameters
