...
func (s *jsiiProxy_SpacesBucketLifecycleRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SpacesBucketLifecycleRuleList) Resolve(context cdktf.IResolveContext) interface{} {
