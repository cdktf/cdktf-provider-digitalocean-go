...
func (j *jsiiProxy_Certificate) validateSetDomainsParameters(val *[]*string) error {
	return nil
}
...
func (j *jsiiProxy_Certificate) validateSetLeafCertificateParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_Certificate) validateSetTypeParameters(val *string) error {
	return nil
}
