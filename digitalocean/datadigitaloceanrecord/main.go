...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDigitaloceanRecord)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-digitalocean.dataDigitaloceanRecord.DataDigitaloceanRecordConfig",
		reflect.TypeOf((*DataDigitaloceanRecordConfig)(nil)).Elem(),
	)
}
