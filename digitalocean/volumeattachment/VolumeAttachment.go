...
import (
	...
	"github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v11/volumeattachment/internal"
...
func (j *jsiiProxy_VolumeAttachment) DropletId() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"dropletId",
...
func (j *jsiiProxy_VolumeAttachment) DropletIdInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"dropletIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.38.0/docs/resources/volume_attachment digitalocean_volume_attachment} Resource.
func NewVolumeAttachment(scope constructs.Construct, id *string, config *VolumeAttachmentConfig) VolumeAttachment {
	...
	_jsii_.Create(
		"@cdktf/provider-digitalocean.volumeAttachment.VolumeAttachment",
...
func (j *jsiiProxy_VolumeAttachment)SetDropletId(val *float64) {
