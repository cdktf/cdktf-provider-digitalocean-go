...
import (
	...
	"github.com/cdktf/cdktf-provider-digitalocean-go/digitalocean/v13/tag/internal"
...
func (j *jsiiProxy_Tag) DatabasesCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"databasesCount",
...
func (j *jsiiProxy_Tag) DropletsCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"dropletsCount",
...
func (j *jsiiProxy_Tag) ImagesCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"imagesCount",
...
func (j *jsiiProxy_Tag) TotalResourceCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"totalResourceCount",
...
func (j *jsiiProxy_Tag) VolumesCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"volumesCount",
...
func (j *jsiiProxy_Tag) VolumeSnapshotsCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/digitalocean/digitalocean/2.58.0/docs/resources/tag digitalocean_tag} Resource.
func NewTag(scope constructs.Construct, id *string, config *TagConfig) Tag {
	...
	_jsii_.Create(
		"@cdktf/provider-digitalocean.tag.Tag",
